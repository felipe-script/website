<template>
  <section class="p-4" id="products">
    <h1
      class="text-xl italic font-semibold text-greenl2 w-1/2 mx-auto mb-12 mt-28"
    >
      <svg
        class="w-8 h-8 text-greend2 mb-4"
        aria-hidden="true"
      ...
      <p>
        ...
        <small class="text-sm">- Morpheus</small>
      </p>
    </h1>
    <div
